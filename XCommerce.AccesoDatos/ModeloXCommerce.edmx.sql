...
-- --------------------------------------------------
-- Date Created: 05/22/2019 02:45:18
-- Generated from EDMX file: C:\Users\kimo\Desktop\TOTAL LAB2\---PROYECTOS----\PARAPROTOTIPADO\2018FLRSV\30_10_2018_TP2_GRUOPO_7\XCommerce.AccesoDatos\ModeloXCommerce.edmx
-- --------------------------------------------------
...
-- Creating foreign key on [ListaPrecio_Id] in table 'Salones'
ALTER TABLE [dbo].[Salones]
ADD CONSTRAINT [FK_SalonListaPrecio]
    FOREIGN KEY ([ListaPrecio_Id])
    REFERENCES [dbo].[ListaPrecios]
        ([Id])
    ON DELETE NO ACTION ON UPDATE NO ACTION;
GO
